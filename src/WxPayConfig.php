...
class WxPayConfig
{
     ...
     * @var string
     */
    public static $APPID = '你的微信公众号 APPID';
    public static $MCHID = '你的微信商户账号';
    public static $KEY = '在微信公众号中设置的APPKEY';
    public static $APPSECRET = '微信密钥';
    public static $NOTIFY_URL = '你接收微信异步返回支付消息的网址';
